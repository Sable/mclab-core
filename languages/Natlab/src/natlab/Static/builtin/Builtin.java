...
public abstract class Builtin {
    ...
    public static class Conj extends AbstractElementalUnaryNumericFunction  {
        ...
        private ClassPropTools.MC matlabClassPropInfo = null; //new ClassPropTools.MCMap(new ClassPropTools.MCBuiltin("logical"),new MCError());
        public ClassPropTools.MC getMatlabClassPropagationInfo(){
            //set classPropInfo if not defined
            if (matlabClassPropInfo == null){
                ClassPropTools.MC parentClassPropInfo = super.getMatlabClassPropagationInfo();
                matlabClassPropInfo = new ClassPropTools.MCMap(new ClassPropTools.MCBuiltin("logical"),new MCError());
            }
    ...
    public static abstract class AbstractRoundingOperation extends AbstractElementalUnaryNumericFunction  {
        ...
        private ClassPropTools.MC matlabClassPropInfo = null; //new ClassPropTools.MCUnion(new ClassPropTools.MCMap(new ClassPropTools.MCBuiltin("logical"),new MCError()),getClassPropagationInfo());
        public ClassPropTools.MC getMatlabClassPropagationInfo(){
            //set classPropInfo if not defined
            if (matlabClassPropInfo == null){
                ClassPropTools.MC parentClassPropInfo = super.getMatlabClassPropagationInfo();
                matlabClassPropInfo = new ClassPropTools.MCUnion(new ClassPropTools.MCMap(new ClassPropTools.MCBuiltin("logical"),new MCError()),getClassPropagationInfo());
            }
            return matlabClassPropInfo;
        }
    ...
    public static abstract class AbstractBinaryNumericFunction extends AbstractProperNumericFunction implements ClassPropagationDefined {
        ...
        private ClassPropTools.MC matlabClassPropInfo = null; //new ClassPropTools.MCUnion(new ClassPropTools.MCMap(new ClassPropTools.MCChain(new ClassPropTools.MCUnion(new ClassPropTools.MCBuiltin("logical"),new ClassPropTools.MCBuiltin("char")),new ClassPropTools.MCNum(0)),new MCError()),new ClassPropTools.MCUnion(new ClassPropTools.MCMap(new ClassPropTools.MCUnion(new ClassPropTools.MCChain(new ClassPropTools.MCUnion(new ClassPropTools.MCUnion(new ClassPropTools.MCUnion(new ClassPropTools.MCUnion(new ClassPropTools.MCBuiltin("int8"),new ClassPropTools.MCBuiltin("uint16")),new ClassPropTools.MCBuiltin("uint32")),new ClassPropTools.MCBuiltin("uint64")),new ClassPropTools.MCUnion(new ClassPropTools.MCUnion(new ClassPropTools.MCUnion(new ClassPropTools.MCBuiltin("int8"),new ClassPropTools.MCBuiltin("uint16")),new ClassPropTools.MCBuiltin("uint32")),new ClassPropTools.MCBuiltin("uint64"))),new ClassPropTools.MCBuiltin("logical")),new ClassPropTools.MCChain(new ClassPropTools.MCBuiltin("logical"),new ClassPropTools.MCUnion(new ClassPropTools.MCUnion(new ClassPropTools.MCUnion(new ClassPropTools.MCUnion(new ClassPropTools.MCBuiltin("int8"),new ClassPropTools.MCBuiltin("uint16")),new ClassPropTools.MCBuiltin("uint32")),new ClassPropTools.MCBuiltin("uint64")),new ClassPropTools.MCUnion(new ClassPropTools.MCUnion(new ClassPropTools.MCUnion(new ClassPropTools.MCBuiltin("int8"),new ClassPropTools.MCBuiltin("uint16")),new ClassPropTools.MCBuiltin("uint32")),new ClassPropTools.MCBuiltin("uint64"))))),new MCError()),getClassPropagationInfo()));
        public ClassPropTools.MC getMatlabClassPropagationInfo(){
            //set classPropInfo if not defined
            if (matlabClassPropInfo == null){
                ClassPropTools.MC parentClassPropInfo = new ClassPropTools.MCNone();
    ...
    public static abstract class AbstractDividingElementalArithmetic extends AbstractElementalBinaryArithmetic  {
        ...
        private ClassPropTools.MC matlabClassPropInfo = null; //new ClassPropTools.MCUnion(new ClassPropTools.MCMap(new ClassPropTools.MCChain(new ClassPropTools.MCBuiltin("logical"),new ClassPropTools.MCBuiltin("logical")),new MCError()),parentClassPropInfo);
        public ClassPropTools.MC getMatlabClassPropagationInfo(){
            //set classPropInfo if not defined
            if (matlabClassPropInfo == null){
                ClassPropTools.MC parentClassPropInfo = super.getMatlabClassPropagationInfo();
                matlabClassPropInfo = new ClassPropTools.MCUnion(new ClassPropTools.MCMap(new ClassPropTools.MCChain(new ClassPropTools.MCBuiltin("logical"),new ClassPropTools.MCBuiltin("logical")),new MCError()),parentClassPropInfo);
            }
            return matlabClassPropInfo;
        }
    ...
    public static class Dot extends AbstractArrayBinaryNumericFunction  {
        ...
        private ClassPropTools.MC matlabClassPropInfo = null; //new ClassPropTools.MCUnion(new ClassPropTools.MCMap(new ClassPropTools.MCChain(new ClassPropTools.MCBuiltin("logical"),new ClassPropTools.MCAny()),new MCError()),getClassPropagationInfo());
        public ClassPropTools.MC getMatlabClassPropagationInfo(){
            //set classPropInfo if not defined
            if (matlabClassPropInfo == null){
                ClassPropTools.MC parentClassPropInfo = super.getMatlabClassPropagationInfo();
                matlabClassPropInfo = new ClassPropTools.MCUnion(new ClassPropTools.MCMap(new ClassPropTools.MCChain(new ClassPropTools.MCBuiltin("logical"),new ClassPropTools.MCAny()),new MCError()),getClassPropagationInfo());
            }
            return matlabClassPropInfo;
        }
