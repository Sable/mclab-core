...
/**
 * Adapted from soot.toolkits.scalar.FlowAnalysis.java
 * Change Log:
 *  - 2008.06 by Jun Li
...
public abstract class FlowAnalysis<N,A> extends AbstractFlowAnalysis<N,A> implements ASTVisitor
{
    ...
    /** Constructs a flow analysis on the given AST tree. */
    public FlowAnalysis(ASTNode tree)
    {
    	super(tree);
     ...
     * for <code>s</code> (or in to out, depending on direction).
     *
	 ...
	 */
/*  Disable it. Currently the tree can only traverse forward, -- JL  
