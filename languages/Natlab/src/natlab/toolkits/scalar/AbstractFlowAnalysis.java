...
/**
 * Adapted from soot.toolkits.scalar.AbstractFlowAnalysis.java
 * Change Log:
 *  - 2008.06 by Jun Li
...
/** An abstract class providing a meta-framework for carrying out
 * data-flow analysis.  This class provides common methods and fields
...
public abstract class AbstractFlowAnalysis<N,A>
{
    ...
    /** The AST being analyzed. Store the root node. */
    protected ASTNode tree;	 

    /** The graph being analyzed. */
    // protected DirectedGraph<N> graph;	// JL

    /** Constructs a flow analysis on the given <code>DirectedGraph</code>. */
    public AbstractFlowAnalysis(ASTNode tree)
    {
    ...
    */        
    ...
    // Temporary debug facility
    static public boolean DEBUG=false;
    static public java.io.PrintStream out;
    static public void setDebug(boolean d) {DEBUG=d; out=System.out;}
    static public void setDebug(boolean d, java.io.PrintStream o) {DEBUG=d; out=o;}
}
