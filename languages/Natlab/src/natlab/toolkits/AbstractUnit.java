...
/**
 * Adapted from soot.AbstractUnit.java
 * Change Log:
 *  - 2008.06 by Jun Li
 *  	- This abstract class is intend to be the one implements Unit interface, 
 *    		except fallsThrough(), branches(). 
 */
...
/* Old: Provides default implementations for the methods in Unit. */
public abstract class AbstractUnit implements Unit 	// extends AbstractHost 
{
    ...
    public void apply(
    		natlab.toolkits.scalar.AbstractFlowAnalysis analysis)
    {
    }
}
