 ...
 * Change Log:
 *  - 2008.06 by Jun Li
 *   	- add apply() for Visit-pattern (Switchable in soot)
 *  	- Inherits interface Value 
 */
 ...
 */
public interface Unit extends Serializable, Value	// , Switchable, Host, Context
{
    /** Interface for Visit pattern, called when this object is visited,  */
	public void apply(
    		natlab.toolkits.analysis.ASTVisitor visitor    		
			);
    ...
    // ASTNode has its own clone() function, so disable this one.  - JL, 
//    public Object clone();
