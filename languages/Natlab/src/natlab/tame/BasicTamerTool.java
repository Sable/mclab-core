...
public class BasicTamerTool {
	...
	public static void main(String[] args){
		...
		GenericFile gFile = GenericFile.create("/media/vineet/19F5-FD4C/Thesis/mclab_git/mclab/languages/Natlab/src/natlab/backends/x10/benchmarks/unit/simplest.m"); //file -> generic file
