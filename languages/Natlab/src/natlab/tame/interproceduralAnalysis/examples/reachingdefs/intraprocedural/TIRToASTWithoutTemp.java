...
public class TIRToASTWithoutTemp extends AbstractTIRLocalRewrite implements TamerPlusTransformation
{
    ...
    public TIRToASTWithoutTemp(ASTNode tree)
    {
        super(tree);
    ...
    public void transform(TransformationEngine engine)
    {
        ...
        fTIRToRawASTTable = analysisEngine.getStmtCollapseByTmpVarRemoval().getTIRToRawASTTable();
