# build script to generate the scanner and parser for the class propagation language.
...
java -jar ../../../../../../../lib/jflex-1.4.1/lib/JFlex.jar classprop.flex 

# build the parser from the grammer, using beaver included in the natlab project
java -jar ../../../../../../../lib/beaver-0.9.6.2/lib/beaver.jar classprop.grammar 
